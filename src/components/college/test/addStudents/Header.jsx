...
const Header = ({ handleFilter, uploadedStudents, setStudents, students, handleNext, handlePrev, disableNext, disablePrev, handleChangeYear }) => {
  ...
  return (
    <div className="flex w-full mx-auto justify-between mb-5 font-dmSans">
      ...
      <button
        className={`self-center justify-center flex bg-accent rounded-lg text-sm font-bold gap-2 px-10 py-3 ${disablePrev && "bg-opacity-30"}`}
        onClick={handlePrev}
      ...
      <button
        className={`self-center justify-center flex bg-accent rounded-lg text-sm font-bold gap-2 px-10 py-3 ${disableNext && "bg-opacity-30"}`}
        onClick={handleNext}
