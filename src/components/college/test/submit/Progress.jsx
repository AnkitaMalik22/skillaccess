...
export const Progress = () => {
  return (
    <>
      <div className="w-4/5 mx-auto flex my-7 font-bold">
        ...
        <div className="w-1/3 flex">
          ...
          <div className="w-full bg-accent h-1/3 self-center -ml-1"></div>
        </div>

        <div className="w-1/3 flex">
          <div className="w-1/3  bg-accent h-1/3 self-center "></div>
          <div className="w-1/3  bg-accent h-1/3 self-center "></div>
          <div className="relative">
            <figure className="w-3 h-3 p-3 rounded-full bg-accent z-50"></figure>
            <h2 className="absolute -bottom-10 w-44 -left-10">
