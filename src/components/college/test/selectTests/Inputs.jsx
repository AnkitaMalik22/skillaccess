      ...
      <div className="flex gap-1 w-full justify-end">
        {type === "adaptive" && (
          <select
            ...
            className="select text-[#171717] font-bold text-sm focus:outline-none focus:ring-1 focus:ring-blued bg-gray-100 w-[250px] xl:w-[320px] h-[56px] rounded-md self-center"
          >
