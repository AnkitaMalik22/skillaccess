  ...
  const [settings, setSettings] = useState({
    options: {
      ...
      markers: {
        ...
        colors: ["#ffffff"],
        strokeColors: ["#0052CC", "#00875A90"], // Set marker border color to blue
        strokeWidth: 2, // Set the border width as needed
      },
    },
    ...
    <div className="sm:flex  mt-6 bg-gray-100 w-full rounded-lg gap-6 font-dmSans  justify-center relative">
      ...
      <div className="w-full  rounded-s sm:px-6 mt-2">
        <div className="md:p-2 flex justify-between">
          <h2 className="font-extrabold text-lg ">RESULTS ANALYTICS</h2>{" "}
