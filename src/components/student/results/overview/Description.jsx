            ...
            <div className="w-64 h-40 bg-white rounded-2xl p-4 relative">
              ...
              <span className="flex flex-col absolute bottom-0 w-full left-0 px-4 py-2">
                ...
                <div className="flex justify-between mb-4">
                  ...
                  <div>
                    {" "}
                    <h2 className="font-bold text-xs text-gray-400 mb-2">
                      Performance
                    </h2>
                  ...
                  <div>
                    ...
                    <span className="flex gap-0">
                      ...
                      <h2 className="font-dmSans font-bold text-xs text-gray-400 sm:text-xs ">
                        {" "}
                        /90
                      </h2>
                    </span>
                ...
                <div className="flex justify-between">
                  ...
                  <p className="text-xs self-center text-blue-500 tracking-[-0.4px] text-left">
                    Review
                  </p>
                </div>
              </span>
