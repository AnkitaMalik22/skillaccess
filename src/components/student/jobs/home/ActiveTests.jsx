    ...
    <div className=" w-[40%] 2xl:w-1/3 h-auto bg-[#f8f8f9] my-3 text-start font-bold text-black rounded-2xl  font-dmSans p-5">
      <div className="logo flex ">
        <div className="w-24 h-24 flex items-center ">
          <img src="/images/default_job.png" alt="" className=" rounded-2xl " />
        </div>
      ...
      <div className="flex flex-row items-start justify-between">
        ...
        <div className="flex items-start justify-between   h-full my-2">
          <button className=" bg-[#c6e1d9] text-[#00875a] rounded-2xl text-sm font-bold flex gap-2 px-7 text-center py-1 ">
            Remote
          </button>
          <button className="  bg-[#c6d7f0] text-blued  rounded-2xl text-sm font-bold flex gap-2 px-7 text-center  py-1 ml-2">
            Full Time
          </button>
        </div>
      </div>
