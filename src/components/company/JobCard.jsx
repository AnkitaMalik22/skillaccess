  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-between mb-4">
        ...
        <span className="text-gray-500 font-medium text-sm">
          ...
          <span className="font-bold text-gray-700">
            {calculateDaysAgo(job?.CloseByDate)}
          </span>
        </span>
      </div>
      ...
      <div className="location flex flex-row items-center mb-4">
        <BsGeoAlt className="w-6 h-6 text-blued mr-3" />
      ...
      {/* Role Overview */}
      <h2 className="my-4 text-gray-700 text-sm line-clamp-2 break-words">
        {job?.RoleOverview}
      </h2>
      ...
      <div className="flex flex-row items-center justify-between">
        <p className="text-[#e45b39] text-sm">
