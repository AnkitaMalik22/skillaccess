...
export default function InviteColleges() {
  ...
  const { loading, colleges, error, pagination } = useSelector((state) => state.campusDrive);
  ...
  const filteredColleges = colleges && colleges?.filter(college =>
  ...
  return (
    <div className="form-card bg-white rounded-lg shadow-lg p-6">
      <h2 className="text-xl font-semibold mb-4 text-gray-700">Step 2: Invite Colleges</h2>
