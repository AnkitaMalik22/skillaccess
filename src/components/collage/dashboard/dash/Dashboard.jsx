    ...
    <>
      <div className=" w-11/12 mx-auto font-dmSans">
        ...
        <div className="bg-gray-100 mt-3 sm:mt-8 rounded-lg ">
          <h1 className="text-base font-bold pt-3 px-6 md:px-8 basis-full">
            Overview
          </h1>
          <div className="flex flex-wrap gap-6 xl:gap-8 2xl:gap-12  justify-center mb-4  px-4 mt-2 pb-6">
            {/* 1st card */}
            <div className="card w-[13%] md:w-[16%] lg:w-[17%] bg-base-100  py-4">
              ...
              <h2 className="text-[30px] text-center font-bold mt-2">
                {students.length}
              </h2>
              <h2 className="text-gray-400 text-center font-bold text-xs mt-2 ">
                Students
              </h2>
              <h2 className="text-green-400 text-center font-bold text-[17px] my-4 ">
                105.34%
              </h2>
            </div>
            ...
            <div className="card w-[13%] md:w-[16%] lg:w-[17%] bg-base-100  py-4">
              ...
              <h2 className="text-red-500 text-center font-bold text-[17px] my-4 ">
                25.34%
              </h2>
            </div>
        ...
        <div className=" gap-2  mx-auto  overflow-x-clip grid grid-cols-2">
          ...
          <div className="bg-gray-100 mt-3 sm:mt-5 rounded-lg   pb-4 mr-1 inline-block p-4">
            <span className="flex justify-between">
              <div className="w-3/4">
                <h1 className="text-sm xl:text-base font-bold  basis-full py-2 ">
