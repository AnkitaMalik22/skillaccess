...
const AddQuestionType = () => {
  ...
  const NavHandler = () => {
    switch (selectQuestionType) {
      case "mcq":
        navigate(`/collage/quesBank/video/${id}/addmcq`);

        break;

      case "short":
        navigate(`/collage/quesBank/video/shortlong/${id}?length=short`);

        break;

      case "long":
        navigate(`/collage/quesBank/video/shortlong/${id}?length=long`);
