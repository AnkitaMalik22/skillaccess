...
const AddVideoQuestionsType = () => {
  ...
  const NavHandler = () => {
    switch (selectQuestionType) {
      case "mcq":
        navigate(`/company/pr/quesBank/video/${id}/addmcq`);

        break;

      case "short":
        navigate(`/company/pr/quesBank/video/shortlong/${id}?length=short`);

        break;

      case "long":
        navigate(`/company/pr/quesBank/video/shortlong/${id}?length=long`);
