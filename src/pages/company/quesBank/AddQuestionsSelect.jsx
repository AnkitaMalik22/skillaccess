...
import HeaderSelect from "../../../components/company/quesBank/addquestions/HeaderSelect";
...
const AddQuestionsSelect = () => {
  ...
  const NavHandler = () => {
    switch (selectQuestionType) {
      ...
      case "code":
        navigate(`/company/pr/quesBank/code/${id}?type=compiler&addType=topic`);
        break;

      case "video":
        navigate(`/company/pr/quesBank/video/${id}?type=video&addType=topic`);
      ...
      case "essay":
        navigate(`/company/pr/quesBank/essay/${id}?type=essay&addType=topic`);
        break;
