...
import Header from "../../../components/college/test/assessment/Header";
  ...
  return (
    <>
      ...
      <div className="flex gap-2 mx-auto mb-5 ">
        ...
        <h2 className="text-sm">Beginner Level</h2>
      </div>
          ...
          {assessment?.topics?.map((topic, index) => (
            <div className="w-full  mb-5 gap-x-10 gap-y-3 p-3 bg-gray-100 rounded-2xl border border-blued h-28">
              ...
              <div className="flex justify-between text-sm font-normal text-gray-400 ">
                ...
                <button
                  className="self-center justify-center bg-gray-200 p-2 rounded-md text-sm hover:bg-blued hover:text-white text-[#171717]"
                  onClick={() =>
                    navigate(
              ...
              {/* <div className="col-span-1  flex justify-center">
                <PiPencilSimpleLine
                  ...
                  onClick={() =>
                    navigate(
                      `/college/test/details/${index}?question=${topic.Type}&type=assessment`
                    )
                  }
                />
              </div> */}
