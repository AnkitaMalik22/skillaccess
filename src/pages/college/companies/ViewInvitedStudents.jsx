        ...
        <div className="min-h-screen">
            <div className="w-full mx-auto bg-white rounded-lg shadow-lg">
                <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">Invited Students</h2>
                    ...
                    <div className="divide-y divide-gray-200">
                        {students?.map((student, index) => (
                            <div 
                                ...
                                className="flex items-center gap-4 py-4 hover:bg-gray-50 px-4 rounded-lg transition-colors"
                            >
