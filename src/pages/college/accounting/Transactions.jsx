  ...
  return (
    <>
      ...
      <div className="transactions flex flex-col w-full">
        ...
        <div className="acc-table  flex flex-col w-full p-6 bg-[#f8f8f9] rounded-md">
          <div className="header grid grid-cols-3 items-center justify-between bg-[#ECF0F7] w-full p-3 mb-3 rounded-md font-bold">
            <p>Date</p>
            <p>Description</p>
            <p>Points Used</p>
          </div>
          <div className="acc-table  flex flex-col w-full rounded-md font-dmSans font-medium">
            ...
            {!fetch_loading && transactions?.length > 0 ? (
              transactions?.map((transaction) => (
                <div className="grid grid-cols-3 items-center justify-between bg-white w-full p-3 mb-3 rounded-md text-sm text-[#171717]">
