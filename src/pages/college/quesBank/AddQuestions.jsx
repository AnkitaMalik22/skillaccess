...
import Header from "../../../components/college/quesBank/addquestions/Header";
import { Progress } from "../../../components/college/quesBank/addquestions/Progress";
                  ...
                  <div className="col-span-1 col-start-9  flex">
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          isUni()
                            ? `/university/pr//test/details/${index}?type=section&question=${topic.Type}&topicId=${topic._id}&view=false&level=${level}`
                  ...
                  <div className="col-span-1  flex justify-center">
                    <PiPencilSimpleLine
                      ...
                      onClick={() =>
                        navigate(
                          isUni()
                            ? `/university/pr/test/details/${index}?type=section&question=${topic.Type}&topicId=${topic._id}&view=true&level=${level}`
