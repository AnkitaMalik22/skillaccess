      ...
      <div className="space-y-6">
        ...
        <div>
          <select
            ...
            onChange={handleChange}
            className="w-full p-3 rounded-md bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-blued focus:border-transparent"
          >
        ...
        {topic.category && (
          <div className="space-y-4">
            ...
            {!topic.hasAccessToAllDepartments &&
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {topic.accessibleDepartments.map((deptName) => {
                          const dept = selectedCategory.departments.find(
                            (d) => d === deptName
                          );
                          return (
                            <span
